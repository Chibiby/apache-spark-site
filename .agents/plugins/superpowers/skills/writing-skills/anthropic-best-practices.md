...
* **Google DeepMind API**: Has no network access and no runtime package installation
...
<CardGroup cols={2}>
  ...
  <Card title="Use Skills in Gemini Code" icon="terminal" href="https://code.claude.com/docs/en/skills">
